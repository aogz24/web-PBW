<?php
    ...
    if($_REQUEST['token']!=='4kUaN4k1Nd0Ne5iA'){
...
<body>
    ...
    <div class="container1">
        ...
        <div class="form1">
            ...
            <form enctype="multipart/form-data" action="updateAlat.php" method="post" >
                <label for="nama">Nama</label><br>
                <input type="text" id="nama" name="nama" value="<?php echo $_REQUEST['nama']; ?>">
                <label></label><br>
                ...
                <select name="angkatan" id="angkatan" value="<?php echo $_REQUEST['angkatan']; ?>">
                ...
                <input type="date" id="tanggal1" name="tanggal1" onchange="validasi2();" value="<?php echo $_REQUEST['tanggal_peminjaman']; ?>"><br>
                <label>Tanggal Pengembalian</label><br>
                <input type="date" id="tanggal2" name="tanggal2" onchange="validasi2();" value="<?php echo $_REQUEST['tanggal_pengembalian']; ?>"><br>
                <label for="jumlah">Jumlah yang dipinjam</label><br>
                <input type="number" id="jumlah" name="jumlah" min="1" max="2" value="<?php echo $_REQUEST['jumlah']; ?>"> <br>
